      ...
      arr.forEach((item) => {
        ...
        tr.innerHTML = `
                    ...
                    <td>
                        ...
                        <button onclick="handleChangeManager('${item.name}')" type="button" class="btn btn-secondary" data-toggle="modal" data-target="#change-manager" title="bổ nhiệm trưởng phòng">
...
function handleChangeManager(name) {
  console.log(name)
  fetch('http://localhost/webcuoiki/admin/api/get_users_of_deparment.php', {
    method: "POST",
    ...
    .then(response => {
      ...
      let selectManager = document.querySelector("#choose-manager");

      userList.forEach(user => {
        let option = document.createElement("option");
        option.innerHTML = user.fullname
        option.value = user.eid
